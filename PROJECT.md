...
- MVP-6: создана Capacitor Android-обёртка и проверенная debug APK 0.1.4 для API 24+. Она содержит offline UI, очередь, экспорт в Documents/Share, deep-link scheme, нативную вставку токена и проверяемое подключение к Vercel. SAF, local notifications и Share Sheet как входной канал ещё не реализованы.
