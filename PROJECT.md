...
- MVP-1: реализованы React/PWA, IndexedDB, постоянная очередь, Hono/SQLite, серверный журнал, retry и экспорт RAW.
...
Node.js 24+, TypeScript, React, Vite, Dexie, Hono, встроенный node:sqlite. SQL-схема и StorageAdapter позволяют добавить PostgreSQL без замены протокола. Для локального запуска Docker и облачные credentials не требуются.
