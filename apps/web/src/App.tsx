...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <div className="workspace">
      ...
      <footer className="workspace-footer"><span><span className="status-dot"/> LOCAL FIRST. ALWAYS.</span><span>VAULT TERMINAL <b>v0.1.2</b></span><button className="text-button" onClick={()=>setSyncPanel(true)}>{queue.length?`${queue.length} в очереди`:'Очередь пуста'}<ArrowRight size={12}/></button></footer>
    </div>
